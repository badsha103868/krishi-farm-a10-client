          ...
          <fieldset className="fieldset">
            ...
            <div className="mt-2">
              <Link
                ...
                className="link link-hover text-green-600 hover:text-green-800 underline text-sm"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              className="btn btn-neutral bg-primary hover:bg-green-500 text-white mt-4"
            >
              Login
            </button>
